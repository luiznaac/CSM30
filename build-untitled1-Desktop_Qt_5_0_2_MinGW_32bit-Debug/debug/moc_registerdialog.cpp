...
#include "../../front/registerdialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_registerDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 28, 21)
    ...
    "registerDialog\0newRegister\0\0"
...
void registerDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->newRegister((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        ...
        {
            typedef void (registerDialog::*_t)(QString , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&registerDialog::newRegister)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void registerDialog::newRegister(QString _t1, QString _t2)
{
